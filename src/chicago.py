...
def remove_images_from_pdf(pdf_path: Path) -> bytes:
    """Remove images from PDF and return compressed PDF as bytes."""
...
def encode_pdf_to_base64(pdf_path: Path) -> str:
    """Remove images from PDF, compress it, and encode to base64 string."""
    pdf_bytes = remove_images_from_pdf(pdf_path)
